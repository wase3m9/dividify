        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="p-8 hover-lift bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-100 rounded-[20px] relative">
            <div className="absolute -top-4 left-6">
              <Badge className="bg-brand-purple hover:bg-brand-purple text-brand-purple-foreground px-3 py-1">
                Step 1
              </Badge>
            </div>
            
            <div className="flex items-center justify-center w-16 h-16 bg-brand-purple rounded-full mb-6 mx-auto">
            ...
            <div className="text-center">
              <span className="text-sm text-brand-purple font-medium">~2 minutes</span>
            </div>
          </Card>
          ...
          <Card className="p-8 hover-lift bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-100 rounded-[20px] relative">
            ...
            <div className="text-center">
              <span className="text-sm text-brand-purple font-medium">~30 seconds</span>
            </div>
          </Card>
          ...
          <Card className="p-8 hover-lift bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-100 rounded-[20px] relative">
            ...
            <div className="text-center">
              <span className="text-sm text-brand-purple font-medium">Instant</span>
            </div>
          </Card>
        </div>
