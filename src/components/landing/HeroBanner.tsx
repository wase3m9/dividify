...
export const HeroBanner = ({
  ...
  return <>
    ...
    <div className="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] min-h-[90vh] bg-gradient-to-b from-purple-100 via-purple-50 to-transparent overflow-hidden">
      ...
      {/* Content container */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-12 items-center min-h-[90vh] py-2 pt-8">
        {/* Left Content */}
        <div className="space-y-8 text-left flex flex-col items-center">
          ...
          <div className="relative inline-flex items-center justify-center gap-4 group animate-fade-in">
            <div className="absolute inset-0 duration-1000 opacity-60 transition-all bg-gradient-to-r from-purple-500 via-purple-400 to-purple-300 rounded-xl blur-lg filter group-hover:opacity-100 group-hover:duration-200"></div>
            <button
