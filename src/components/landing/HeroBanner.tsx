  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] py-16 px-4 md:px-6">
      <div className="max-w-4xl mx-auto text-center space-y-8">
        <div className="relative inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-100 text-gray-600 text-sm mb-8 animate-fade-in overflow-hidden">
          <div className="absolute -inset-0.5 rounded-full bg-gradient-to-r from-transparent via-brand-purple to-transparent opacity-75 animate-shimmer bg-[length:200%_100%]"></div>
