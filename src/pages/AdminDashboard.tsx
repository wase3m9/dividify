                ...
                {docStatsLoading ? (
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <BarChart data={[...docStats].reverse()}>
                      ...
                      />
                      <Legend />
                      <Bar dataKey="vouchers" fill="hsl(var(--primary))" name="Vouchers" />
                      <Bar dataKey="minutes" fill="hsl(var(--chart-2))" name="Minutes" />
                    </BarChart>
                  </ResponsiveContainer>
                ) : (
                  <div className="h-[300px] flex items-center justify-center text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-muted-foreground">
                User management, billing, and other features coming soon...
              </div>
            </CardContent>
          </Card>
        </div>
