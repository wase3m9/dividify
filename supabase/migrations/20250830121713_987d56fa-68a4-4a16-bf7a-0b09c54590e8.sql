-- Create RPC functions to increment monthly counters
...
-- Create function to reset monthly counters (this should be called monthly)
...
-- Create function to check if user is in new billing period and reset counters if needed
